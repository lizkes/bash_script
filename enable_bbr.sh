...
installxanmod(){
	...
	if [[ "${release}" == "centos" ]]; then
		...
		if [[ ${bit} = "x86_64" ]]; then
			kernel_version="5.10.8-xanmod1"
			detele_kernel_head
			wget -N -O linux-headers-d10.deb https://sourceforge.net/projects/xanmod/files/releases/stable/5.10.8-xanmod1/linux-headers-5.10.8-xanmod1_5.10.8-xanmod1-0%7Egit20210117.3598ba8_amd64.deb/download
			wget -N -O linux-image-d10.deb https://sourceforge.net/projects/xanmod/files/releases/stable/5.10.8-xanmod1/linux-image-5.10.8-xanmod1_5.10.8-xanmod1-0%7Egit20210117.3598ba8_amd64.deb/download
